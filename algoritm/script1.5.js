...
console.log(cas1(7))
console.log('next')
// Дано целое число в диапазоне 20–49, определяющее возраст (в годах). Вывести строку-описание указанного возраста,
...
// const yearsDeclination = (year) => {
//
//     if(year === 21 || year === 31 || year === 41 ) {
//
//     } else if((year > 21 && year < 25) || (year > 31 && year < 35) || (year > 41 && year < 45) ){
//
//     } else {
//
//     }
